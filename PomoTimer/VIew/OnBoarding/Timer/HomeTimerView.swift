                ...
                GeometryReader{proxy in
                    VStack(spacing: 15) {
                        ...
                        ZStack{
                            ...
                            Circle().trim(from: 0, to: pomodoroModel.progress)
                                .stroke(.white.opacity(0.03), lineWidth: 80)
                            
                            //MARK: Shadow
                            Circle()
                                .stroke(Color("Tomato"), lineWidth: 5)
                                .blur(radius: 15)
                                .padding(-2)
                            ...
                            Circle()
                                ...
                                .stroke(Color("Tomato").opacity(0.7), lineWidth: 10)
                            ...
                            GeometryReader{proxy in
                                ...
                                //MARK: Karena view berotasi maka kita pakai x /2
                        ...
                        Button {
                            ...
                            Image(systemName: !pomodoroModel.isStarted ? "timer" : "pause")
                                ...
                                .shadow(color: Color("Tomato"), radius: 8, x: 0, y: 0)
                        }
                    }
                    .frame(maxWidth: .infinity, maxHeight: .infinity, alignment: .center)
                }
...
struct HomeTimerView_Previews: PreviewProvider {
